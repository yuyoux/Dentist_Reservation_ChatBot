...
class WitaiCaller extends Component {
  constructor(props) {
    super(props);
  ...
  componentWillMount() {
    ...
    const url = `http://127.0.0.1:5000/v1/DentistResevation/${search}`;
...
WitaiCaller.propTypes = {
  steps: PropTypes.object,
  triggerNextStep: PropTypes.func
};

WitaiCaller.defaultProps = {
  steps: undefined,
  triggerNextStep: undefined
};

export default WitaiCaller;
