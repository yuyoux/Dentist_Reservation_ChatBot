...
definitions = {'definitions': {'Error': {'type': 'object', 'properties': {'code': {'type': 'string'}, 'message': {'type': 'string'}}, 'required': ['code', 'message']}}, 'parameters': {}}

validators = {
}

filters = {
    ('DentistResevation_expression', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'response': {'type': 'string'}}}}, 400: {'headers': None, 'schema': {'$ref': '#/definitions/Error'}}},
}
